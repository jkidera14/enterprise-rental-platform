...
const DiscoverSection = () => {
    return (
        ...
        >
            <div className="max-w-6xl xl:max-w-7xl mx-auto px-6 sm:x-8 lg:px-12 xl:px-16 ">
                <motion.div
                ...
                >
                    ...
                    <p className="mt-2 text-gray-500 max-w-3xl mx-auto">
                        Searching fr your dream rental property has never been easier. With
                    ...
                    {[
                        {
                            ...
                            description: "Browse through our extensive listing of rental properties in your desired location.",
                        },
                        {
...
const DiscoverCard = ({
    ...
    <div className="px-4 y-12 shadow-lg rounded-lg bg-primary-50 md:h-72">
